...
import CoverDatesTab from "@/modules/registration/corporate-renew/components/cover-dates-tab";
import CategoriesTab from "@/modules/registration/corporate/components/categories/categories-tab";
import ContactPersonTab from "@/modules/registration/corporate/components/contact-person/contact-person-tab";
import CorporateTab from "@/modules/registration/corporate/components/corporate/corporate-tab";
import ProvidersTab from "@/modules/registration/corporate/components/provider/providers-tab";
import RegulationsTab from "@/modules/registration/corporate/components/regulations/regulations-tab";
import BioDataTab from "@/modules/registration/manage-members/components/bio-data/bio-data-tab";
  ...
  Corporate: [
    {
      ...
      tabs: [
        ...
        },
        {
          value: "status",
          label: "Status",
          content: <PlaceholderContent title="Status" />,
        },
        {
          value: "rates",
          label: "Rates",
          content: <PlaceholderContent title="Rates" />,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      tabs: [
        {
          value: "group-excess-limit", // Fixed kebab case consistency
  ...
  Members: [
    {
      ...
      tabs: [
        ...
        },
        {
          value: "rate-member",
          label: "Rate Members",
          content: <PlaceholderContent title="Rate Members" />,
        },
      ],
    },
    {
      ...
      tabs: [
        {
          ...
          content: <PlaceholderContent title="Upload With Member Numbers" />, // Fixed title
        },
      ],
    },
    {
      ...
      tabs: [
        {
          ...
          content: <PlaceholderContent title="Change Member's Corporate" />, // Fixed title
        },
      ],
    },
  ],
      ...
      tabs: [
        {
          ...
          label: "Member Statement", // Fixed empty label
